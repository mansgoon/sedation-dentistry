        ...
        <div className="flex flex-col mt-1 max-sm:mx-auto max-sm:text-center">
          ...
          <div className="flex gap-5 mt-5">
            <div className="flex flex-col items-center self-start">
              <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/696ffb9137b1d6b661a2a6b46a1670d18169e0c4ffad2f1063dfb30209d675a8?apiKey=ea3aca9057654e45a61207978509cdea&" alt="Phone icon" className="w-6 aspect-square" />
              <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/35e1e9ef41381842e12ca31779d5d68c5348ff2a564fe5e08aa4b17f95b7bd11?apiKey=ea3aca9057654e45a61207978509cdea&" alt="Email icon" className="mt-3 w-6 aspect-square" />
            </div>
